...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Monte sua loja online em minutos. Catálogo público, variações de produto, controle de estoque e checkout direto no WhatsApp." },
    ],
  }),
  component: Landing,
});
      ...
      <header className="border-b border-border/60 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          ...
          <nav className="flex items-center gap-2">
            ...
            <a href="https://wa.me/5583994043126" target="_blank" rel="noopener noreferrer">
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 md:py-28">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mt-6 text-4xl font-bold tracking-tight md:text-6xl">
            Sua loja de roupas online,<br />simples como o Instagram.
          </h1>
        ...
        <div id="features" className="mt-24 grid gap-6 md:grid-cols-4">
          {[
            { icon: ShoppingBag, t: "Catálogo público", d: "Link único da sua loja, pronto para compartilhar." },
            { icon: Layers, t: "Variações", d: "Tamanho, cor e numeração com estoque por variação." },
            { icon: Smartphone, t: "Mobile-first", d: "Visual moderno em qualquer tela, leve e rápido." },
            { icon: Zap, t: "Checkout WhatsApp", d: "Carrinho gera mensagem pronta com itens e total." },
          ].map(({ icon: Icon, t, d }) => (
